...
static NSString * const kConsumerKey       = @"EJzgFLJLcVvskY8QBCxANg";
static NSString * const kConsumerSecret    = @"M5MNmVNUy5FaVkvmcthaVtEzEPY";
static NSString * const kToken             = @"QIk1X2dRFMJbg_gktBJLXljzk3KVv2N6";
static NSString * const kTokenSecret       = @"RDi_Ja-z9pOsqu2dFU2DP49guFQ";
